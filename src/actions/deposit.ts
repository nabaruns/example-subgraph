...
import { eventId, snapshotFinancials, snapshotMarket, snapshotUsage, updateMarketSnapshots } from ".";
...
export function _handleMint(data: cosmos.EventData): void {
    ...
    const minter = event.getAttributeValue("sender");
    ...
    market.totalDepositBalanceUSD = market.totalDepositBalanceUSD.plus(depositUSD);
